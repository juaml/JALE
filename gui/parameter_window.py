...
class ParameterWindow(customtkinter.CTkToplevel):
    def __init__(self, master, controller):
        ...
        self.title_label = customtkinter.CTkLabel(
            self, text="Parameter Settings", font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.tfce_enabled_checkbox.grid(
        ...
        try:
            ...
            if value < 100 or value > 100000:
                messagebox.showerror(
                    "Invalid Input", "Monte Carlo iterations must be a whole number between 100 and 100,000.")
    ...
    def validate_cluster_forming_threshold(self):
        ...
        try:
            ...
            if value < 0.00001 or value > 0.05:
                messagebox.showerror(
                    "Invalid Input", "cFWE cluster forming threshold must be between 0.00001 and 0.05.")
    ...
    def validate_subsampling_n(self):
        try:
            ...
            if value < 100 or value > 25000:
                messagebox.showerror(
                    "Invalid Input", "IPA subsampling N must be a whole number between 100 and 25000.")
    ...
    def apply_parameters(self):
        ...
        self.after(2000, lambda: self.apply_button.configure(
            fg_color='#20548c', text='Apply'))
...
class ParameterWarningWindow(customtkinter.CTkToplevel):
    def __init__(self, master, controller):
        ...
        self.warning_label = customtkinter.CTkLabel(
            self, text="Default parameter values are set automatically.\nChanging parameters only advised for experts.",
