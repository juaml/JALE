...
class Controller:
    def __init__(self, sidebar_frame, analysis_table_frame, dataset_table_frame, output_log_frame):
         ...
         # ALE objects
         self.analysis_df = pd.DataFrame(columns=['analysis_type', 'analysis_name', 'group1_logic', 'group2_logic'])
    ...
    def import_analysis_file(self, filename):
        ...
        self.analysis_df = self.analysis_table_frame.format_imported_analysis_file(self.analysis_df)
